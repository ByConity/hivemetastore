...
class ThriftHiveMetastoreIf {
 public:
  ...
  virtual void get_partitions_with_order(std::vector<Partition> & _return, const std::string& db_name, const std::string& tbl_name, const int16_t max_parts, const bool is_asc) = 0;
  ...
  virtual bool set_token(const std::string& token) = 0;
  virtual bool set_token_with_namespace(const std::string& token, const std::string& name_space) = 0;
...
class ThriftHiveMetastoreIfSingletonFactory : virtual public ThriftHiveMetastoreIfFactory {
 public:
  ...
  virtual void releaseHandler(ThriftHiveMetastoreIf* /* handler */) override {}
...
class ThriftHiveMetastoreNull : virtual public ThriftHiveMetastoreIf {
 public:
  ...
  void create_table_with_constraints(const Table& /* tbl */, const std::vector<SQLPrimaryKey> & /* primaryKeys */, const std::vector<SQLForeignKey> & /* foreignKeys */, const std::vector<SQLUniqueConstraint> & /* uniqueConstraints */, const std::vector<SQLNotNullConstraint> & /* notNullConstraints */) override {
    return;
  }
  ...
  void get_partitions_with_order(std::vector<Partition> & /* _return */, const std::string& /* db_name */, const std::string& /* tbl_name */, const int16_t /* max_parts */, const bool /* is_asc */) override {
    return;
  }
  ...
  void add_index(Index& /* _return */, const Index& /* new_index */, const Table& /* index_table */) override {
    return;
  }
  void alter_index(const std::string& /* dbname */, const std::string& /* base_tbl_name */, const std::string& /* idx_name */, const Index& /* new_idx */) override {
    return;
  }
  bool drop_index_by_name(const std::string& /* db_name */, const std::string& /* tbl_name */, const std::string& /* index_name */, const bool /* deleteData */) override {
    bool _return = false;
    return _return;
  }
  ...
  void get_index_names(std::vector<std::string> & /* _return */, const std::string& /* db_name */, const std::string& /* tbl_name */, const int16_t /* max_indexes */) override {
    return;
  }
  ...
  bool delete_partition_column_statistics(const std::string& /* db_name */, const std::string& /* tbl_name */, const std::string& /* part_name */, const std::string& /* col_name */) override {
    bool _return = false;
    return _return;
  }
  bool delete_table_column_statistics(const std::string& /* db_name */, const std::string& /* tbl_name */, const std::string& /* col_name */) override {
    bool _return = false;
    return _return;
  }
  ...
  bool set_token(const std::string& /* token */) override {
    bool _return = false;
    return _return;
  }
  bool set_token_with_namespace(const std::string& /* token */, const std::string& /* name_space */) override {
    bool _return = false;
    return _return;
  }
...
typedef struct _ThriftHiveMetastore_get_partitions_with_order_args__isset {
  _ThriftHiveMetastore_get_partitions_with_order_args__isset() : db_name(false), tbl_name(false), max_parts(true), is_asc(false) {}
  bool db_name :1;
  bool tbl_name :1;
  bool max_parts :1;
  bool is_asc :1;
} _ThriftHiveMetastore_get_partitions_with_order_args__isset;

class ThriftHiveMetastore_get_partitions_with_order_args {
 public:

  ThriftHiveMetastore_get_partitions_with_order_args(const ThriftHiveMetastore_get_partitions_with_order_args&);
  ThriftHiveMetastore_get_partitions_with_order_args& operator=(const ThriftHiveMetastore_get_partitions_with_order_args&);
  ThriftHiveMetastore_get_partitions_with_order_args() noexcept
                                                     : db_name(),
                                                       tbl_name(),
                                                       max_parts(-1),
                                                       is_asc(0) {
  ...
  virtual ~ThriftHiveMetastore_get_partitions_with_order_args() noexcept;
  std::string db_name;
  std::string tbl_name;
  int16_t max_parts;
  bool is_asc;

  _ThriftHiveMetastore_get_partitions_with_order_args__isset __isset;
  ...
  bool operator == (const ThriftHiveMetastore_get_partitions_with_order_args & rhs) const
  {
    if (!(db_name == rhs.db_name))
      return false;
    if (!(tbl_name == rhs.tbl_name))
  ...
  bool operator < (const ThriftHiveMetastore_get_partitions_with_order_args & ) const;
...
class ThriftHiveMetastore_get_partitions_with_order_pargs {
 public:


  virtual ~ThriftHiveMetastore_get_partitions_with_order_pargs() noexcept;
  const std::string* db_name;
  const std::string* tbl_name;
  const int16_t* max_parts;
  const bool* is_asc;
...
typedef struct _ThriftHiveMetastore_get_partitions_with_order_result__isset {
  _ThriftHiveMetastore_get_partitions_with_order_result__isset() : success(false), o1(false), o2(false) {}
  bool success :1;
  bool o1 :1;
  bool o2 :1;
} _ThriftHiveMetastore_get_partitions_with_order_result__isset;

class ThriftHiveMetastore_get_partitions_with_order_result {
 public:

  ThriftHiveMetastore_get_partitions_with_order_result(const ThriftHiveMetastore_get_partitions_with_order_result&);
  ThriftHiveMetastore_get_partitions_with_order_result& operator=(const ThriftHiveMetastore_get_partitions_with_order_result&);
  ThriftHiveMetastore_get_partitions_with_order_result() noexcept {
  }

  virtual ~ThriftHiveMetastore_get_partitions_with_order_result() noexcept;
  std::vector<Partition>  success;
  NoSuchObjectException o1;
  MetaException o2;

  _ThriftHiveMetastore_get_partitions_with_order_result__isset __isset;
  ...
  bool operator == (const ThriftHiveMetastore_get_partitions_with_order_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    if (!(o1 == rhs.o1))
  ...
  bool operator < (const ThriftHiveMetastore_get_partitions_with_order_result & ) const;
...
typedef struct _ThriftHiveMetastore_get_partitions_with_order_presult__isset {
  _ThriftHiveMetastore_get_partitions_with_order_presult__isset() : success(false), o1(false), o2(false) {}
  bool success :1;
  bool o1 :1;
  bool o2 :1;
} _ThriftHiveMetastore_get_partitions_with_order_presult__isset;

class ThriftHiveMetastore_get_partitions_with_order_presult {
 public:


  virtual ~ThriftHiveMetastore_get_partitions_with_order_presult() noexcept;
  std::vector<Partition> * success;
  NoSuchObjectException o1;
  MetaException o2;

  _ThriftHiveMetastore_get_partitions_with_order_presult__isset __isset;
...
class ThriftHiveMetastore_alter_index_args {
 public:
  ...
  ThriftHiveMetastore_alter_index_args() noexcept
                                       : dbname(),
                                         base_tbl_name(),
                                         idx_name() {
  }
...
class ThriftHiveMetastore_alter_index_result {
 public:
  ...
  ThriftHiveMetastore_alter_index_result() noexcept {
  }
...
class ThriftHiveMetastore_get_index_names_args {
 public:
  ...
  ThriftHiveMetastore_get_index_names_args() noexcept
                                           : db_name(),
                                             tbl_name(),
                                             max_indexes(-1) {
  }
...
class ThriftHiveMetastore_get_index_names_result {
 public:
  ...
  ThriftHiveMetastore_get_index_names_result() noexcept {
  }
...
typedef struct _ThriftHiveMetastore_set_token_args__isset {
  _ThriftHiveMetastore_set_token_args__isset() : token(false) {}
  bool token :1;
} _ThriftHiveMetastore_set_token_args__isset;

class ThriftHiveMetastore_set_token_args {
 public:

  ThriftHiveMetastore_set_token_args(const ThriftHiveMetastore_set_token_args&);
  ThriftHiveMetastore_set_token_args& operator=(const ThriftHiveMetastore_set_token_args&);
  ThriftHiveMetastore_set_token_args() noexcept
                                     : token() {
  }

  virtual ~ThriftHiveMetastore_set_token_args() noexcept;
  std::string token;

  _ThriftHiveMetastore_set_token_args__isset __isset;

  void __set_token(const std::string& val);

  bool operator == (const ThriftHiveMetastore_set_token_args & rhs) const
  {
    if (!(token == rhs.token))
      return false;
    return true;
  ...
  bool operator < (const ThriftHiveMetastore_set_token_args & ) const;
...
class ThriftHiveMetastore_set_token_pargs {
 public:


  virtual ~ThriftHiveMetastore_set_token_pargs() noexcept;
...
typedef struct _ThriftHiveMetastore_set_token_result__isset {
  _ThriftHiveMetastore_set_token_result__isset() : success(false), o1(false) {}
  bool success :1;
  bool o1 :1;
} _ThriftHiveMetastore_set_token_result__isset;

class ThriftHiveMetastore_set_token_result {
 public:

  ThriftHiveMetastore_set_token_result(const ThriftHiveMetastore_set_token_result&);
  ThriftHiveMetastore_set_token_result& operator=(const ThriftHiveMetastore_set_token_result&);
  ThriftHiveMetastore_set_token_result() noexcept
                                       : success(0) {
  }

  virtual ~ThriftHiveMetastore_set_token_result() noexcept;
  bool success;
  MetaException o1;

  _ThriftHiveMetastore_set_token_result__isset __isset;

  void __set_success(const bool val);

  void __set_o1(const MetaException& val);

  bool operator == (const ThriftHiveMetastore_set_token_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    if (!(o1 == rhs.o1))
  ...
  bool operator < (const ThriftHiveMetastore_set_token_result & ) const;
...
typedef struct _ThriftHiveMetastore_set_token_presult__isset {
  _ThriftHiveMetastore_set_token_presult__isset() : success(false), o1(false) {}
  bool success :1;
  bool o1 :1;
} _ThriftHiveMetastore_set_token_presult__isset;

class ThriftHiveMetastore_set_token_presult {
 public:


  virtual ~ThriftHiveMetastore_set_token_presult() noexcept;
  bool* success;
  MetaException o1;

  _ThriftHiveMetastore_set_token_presult__isset __isset;

  uint32_t read(::apache::thrift::protocol::TProtocol* iprot);

};

typedef struct _ThriftHiveMetastore_set_token_with_namespace_args__isset {
  _ThriftHiveMetastore_set_token_with_namespace_args__isset() : token(false), name_space(false) {}
  bool token :1;
  bool name_space :1;
} _ThriftHiveMetastore_set_token_with_namespace_args__isset;

class ThriftHiveMetastore_set_token_with_namespace_args {
 public:

  ThriftHiveMetastore_set_token_with_namespace_args(const ThriftHiveMetastore_set_token_with_namespace_args&);
  ThriftHiveMetastore_set_token_with_namespace_args& operator=(const ThriftHiveMetastore_set_token_with_namespace_args&);
  ThriftHiveMetastore_set_token_with_namespace_args() noexcept
                                                    : token(),
                                                      name_space() {
  }

  virtual ~ThriftHiveMetastore_set_token_with_namespace_args() noexcept;
  std::string token;
  std::string name_space;

  _ThriftHiveMetastore_set_token_with_namespace_args__isset __isset;

  void __set_token(const std::string& val);

  void __set_name_space(const std::string& val);

  bool operator == (const ThriftHiveMetastore_set_token_with_namespace_args & rhs) const
  {
    if (!(token == rhs.token))
      return false;
    if (!(name_space == rhs.name_space))
      return false;
    return true;
  }
  bool operator != (const ThriftHiveMetastore_set_token_with_namespace_args &rhs) const {
  ...
  bool operator < (const ThriftHiveMetastore_set_token_with_namespace_args & ) const;
...
class ThriftHiveMetastore_set_token_with_namespace_pargs {
 public:


  virtual ~ThriftHiveMetastore_set_token_with_namespace_pargs() noexcept;
  const std::string* token;
...
typedef struct _ThriftHiveMetastore_set_token_with_namespace_result__isset {
  _ThriftHiveMetastore_set_token_with_namespace_result__isset() : success(false), o1(false) {}
  bool success :1;
  bool o1 :1;
} _ThriftHiveMetastore_set_token_with_namespace_result__isset;

class ThriftHiveMetastore_set_token_with_namespace_result {
 public:

  ThriftHiveMetastore_set_token_with_namespace_result(const ThriftHiveMetastore_set_token_with_namespace_result&);
  ThriftHiveMetastore_set_token_with_namespace_result& operator=(const ThriftHiveMetastore_set_token_with_namespace_result&);
  ThriftHiveMetastore_set_token_with_namespace_result() noexcept
                                                      : success(0) {
  }

  virtual ~ThriftHiveMetastore_set_token_with_namespace_result() noexcept;
  bool success;
  MetaException o1;

  _ThriftHiveMetastore_set_token_with_namespace_result__isset __isset;

  void __set_success(const bool val);

  void __set_o1(const MetaException& val);

  bool operator == (const ThriftHiveMetastore_set_token_with_namespace_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    if (!(o1 == rhs.o1))
  ...
  bool operator < (const ThriftHiveMetastore_set_token_with_namespace_result & ) const;
...
typedef struct _ThriftHiveMetastore_set_token_with_namespace_presult__isset {
  _ThriftHiveMetastore_set_token_with_namespace_presult__isset() : success(false), o1(false) {}
  bool success :1;
  bool o1 :1;
} _ThriftHiveMetastore_set_token_with_namespace_presult__isset;

class ThriftHiveMetastore_set_token_with_namespace_presult {
 public:


  virtual ~ThriftHiveMetastore_set_token_with_namespace_presult() noexcept;
  bool* success;
  MetaException o1;

  _ThriftHiveMetastore_set_token_with_namespace_presult__isset __isset;
...
class ThriftHiveMetastore_abort_txn_args {
 public:
  ...
  ThriftHiveMetastore_abort_txn_args(const ThriftHiveMetastore_abort_txn_args&) noexcept;
  ThriftHiveMetastore_abort_txn_args& operator=(const ThriftHiveMetastore_abort_txn_args&) noexcept;
...
class ThriftHiveMetastore_commit_txn_args {
 public:
  ...
  ThriftHiveMetastore_commit_txn_args(const ThriftHiveMetastore_commit_txn_args&) noexcept;
  ThriftHiveMetastore_commit_txn_args& operator=(const ThriftHiveMetastore_commit_txn_args&) noexcept;
...
class ThriftHiveMetastore_get_next_notification_args {
 public:
  ...
  ThriftHiveMetastore_get_next_notification_args(const ThriftHiveMetastore_get_next_notification_args&) noexcept;
  ThriftHiveMetastore_get_next_notification_args& operator=(const ThriftHiveMetastore_get_next_notification_args&) noexcept;
...
class ThriftHiveMetastore_fire_listener_event_result {
 public:
  ...
  ThriftHiveMetastore_fire_listener_event_result(const ThriftHiveMetastore_fire_listener_event_result&) noexcept;
  ThriftHiveMetastore_fire_listener_event_result& operator=(const ThriftHiveMetastore_fire_listener_event_result&) noexcept;
...
class ThriftHiveMetastore_get_active_resource_plan_args {
 public:
  ...
  ThriftHiveMetastore_get_active_resource_plan_args(const ThriftHiveMetastore_get_active_resource_plan_args&) noexcept;
  ThriftHiveMetastore_get_active_resource_plan_args& operator=(const ThriftHiveMetastore_get_active_resource_plan_args&) noexcept;
...
class ThriftHiveMetastore_get_all_resource_plans_args {
 public:
  ...
  ThriftHiveMetastore_get_all_resource_plans_args(const ThriftHiveMetastore_get_all_resource_plans_args&) noexcept;
  ThriftHiveMetastore_get_all_resource_plans_args& operator=(const ThriftHiveMetastore_get_all_resource_plans_args&) noexcept;
...
class ThriftHiveMetastoreClient : virtual public ThriftHiveMetastoreIf {
 ...
 public:
  ...
  void get_partitions_with_order(std::vector<Partition> & _return, const std::string& db_name, const std::string& tbl_name, const int16_t max_parts, const bool is_asc) override;
  void send_get_partitions_with_order(const std::string& db_name, const std::string& tbl_name, const int16_t max_parts, const bool is_asc);
  void recv_get_partitions_with_order(std::vector<Partition> & _return);
  void get_partitions_with_auth(std::vector<Partition> & _return, const std::string& db_name, const std::string& tbl_name, const int16_t max_parts, const std::string& user_name, const std::vector<std::string> & group_names) override;
  ...
  bool set_token(const std::string& token) override;
  void send_set_token(const std::string& token);
  bool recv_set_token();
  bool set_token_with_namespace(const std::string& token, const std::string& name_space) override;
  void send_set_token_with_namespace(const std::string& token, const std::string& name_space);
  bool recv_set_token_with_namespace();
  void get_delegation_token(std::string& _return, const std::string& token_owner, const std::string& renewer_kerberos_principal_name) override;
...
class ThriftHiveMetastoreProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 private:
  ...
  void process_get_partitions_with_order(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
  ...
  void process_set_token(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
  void process_set_token_with_namespace(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
 ...
 public:
  ThriftHiveMetastoreProcessor(::std::shared_ptr<ThriftHiveMetastoreIf> iface) :
    ...
    processMap_["get_partitions_with_order"] = &ThriftHiveMetastoreProcessor::process_get_partitions_with_order;
    ...
    processMap_["set_token"] = &ThriftHiveMetastoreProcessor::process_set_token;
    processMap_["set_token_with_namespace"] = &ThriftHiveMetastoreProcessor::process_set_token_with_namespace;
...
class ThriftHiveMetastoreMultiface : virtual public ThriftHiveMetastoreIf {
 ...
 public:
  ...
  void get_partitions_with_order(std::vector<Partition> & _return, const std::string& db_name, const std::string& tbl_name, const int16_t max_parts, const bool is_asc) override {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->get_partitions_with_order(_return, db_name, tbl_name, max_parts, is_asc);
    }
    ifaces_[i]->get_partitions_with_order(_return, db_name, tbl_name, max_parts, is_asc);
    return;
  }
  ...
  bool set_token(const std::string& token) override {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->set_token(token);
    }
    return ifaces_[i]->set_token(token);
  }
  ...
  bool set_token_with_namespace(const std::string& token, const std::string& name_space) override {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->set_token_with_namespace(token, name_space);
    }
    return ifaces_[i]->set_token_with_namespace(token, name_space);
  }
  ...
  ThriftHiveMetastoreConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot, std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
 ...
 public:
  ...
  void get_partitions_with_order(std::vector<Partition> & _return, const std::string& db_name, const std::string& tbl_name, const int16_t max_parts, const bool is_asc) override;
  int32_t send_get_partitions_with_order(const std::string& db_name, const std::string& tbl_name, const int16_t max_parts, const bool is_asc);
  void recv_get_partitions_with_order(std::vector<Partition> & _return, const int32_t seqid);
  void get_partitions_with_auth(std::vector<Partition> & _return, const std::string& db_name, const std::string& tbl_name, const int16_t max_parts, const std::string& user_name, const std::vector<std::string> & group_names) override;
  ...
  bool set_token(const std::string& token) override;
  int32_t send_set_token(const std::string& token);
  bool recv_set_token(const int32_t seqid);
  bool set_token_with_namespace(const std::string& token, const std::string& name_space) override;
  int32_t send_set_token_with_namespace(const std::string& token, const std::string& name_space);
  bool recv_set_token_with_namespace(const int32_t seqid);
  void get_delegation_token(std::string& _return, const std::string& token_owner, const std::string& renewer_kerberos_principal_name) override;
